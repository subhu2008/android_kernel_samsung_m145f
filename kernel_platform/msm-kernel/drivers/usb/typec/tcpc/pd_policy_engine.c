...
extern int power_off_mode; // ExtB OAK-8292, tankaikun@wt, modify 20220324, fix power off discharge when type change HVDCP to PD
	...
	struct pd_port *pd_port, struct pd_event *pd_event)
{
	...
	pd_disable_timer(pd_port, PD_TIMER_NO_SEND);
