...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE, 28, 30), /* Not used. */
...
DECL_TCPC_TIMEOUT(PD_TIMER_NO_SEND, 100),
...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SRC_RECOVER, 660, 660),
...
DECL_TCPC_TIMEOUT(PD_TIMER_HARD_RESET_SAFE5V, 2500),
...
DECL_TCPC_TIMEOUT(PD_TIMER_VSAFE0V_TOUT, 250),
...
DECL_TCPC_TIMEOUT(TYPEC_TIMER_SNK_WAIT_UPDATE, 10000),
	...
	tcpc_timer_wakeup(struct alarm *alarm, ktime_t now)
{
	...
	schedule_delayed_work(&tcpc->wake_up_work, msecs_to_jiffies(500));
