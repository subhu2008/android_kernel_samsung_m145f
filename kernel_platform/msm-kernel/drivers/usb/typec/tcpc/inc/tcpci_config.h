...
#define CONFIG_USB_PD_ATTEMPT_ENTER_MODE

#define CONFIG_USB_PD_ALT_MODE
#ifdef CONFIG_USB_PD_ALT_MODE
#define CONFIG_USB_PD_ALT_MODE_DFP
#undef CONFIG_USB_PD_ALT_MODE_RTDC
...
#define CONFIG_USB_PD_REV30_SYNC_SVDM_VER
...
#define CONFIG_USB_PD_REV30_SNK_CAP_EXT_LOCAL
...
#define CONFIG_USB_PD_REV30_REVISION_LOCAL
