...
#define HX9031AS_REPORT_EVKEY 0            //选择上报事件类型report 1:EV_KEY 0:EV_ABS
...
#define HX9031AS_ID_CHECK_COUNT 1
#define HX9031AS_CHIP_ID 0x1D //chip_id是0x1D
...
static struct hx9031as_addr_val_pair hx9031as_reg_init_list_a[] = {
    
    {RW_24_CH_NUM_CFG,                 0x00},
    {RW_00_GLOBAL_CTRL0,               0x40},
    {RW_01_GLOBAL_CTRL1,               0x02},
    
    {RW_02_PRF_CFG,                    0x16},
    {RW_0D_RANGE_7_0,                  0x30},
    ...
    {RW_2C_UP_ALP_1_0_CFG,             0x77},
    {RW_2D_UP_ALP_3_2_CFG,             0x77},
    {RW_2E_DN_UP_ALP_0_4_CFG,          0x10},
    {RW_2F_DN_ALP_2_1_CFG,             0x11},
    {RW_30_DN_ALP_4_3_CFG,             0x01},

    {RW_38_RAW_BL_RD_CFG,              0xF0},
    {RW_39_INTERRUPT_CFG,              0xFF},
    {RW_3B_CALI_DIFF_CFG,              0x02},
    {RW_6C_PROX_INT_HIGH_CFG,          0x03},
    {RW_6D_PROX_INT_LOW_CFG,           0x03},
...
static struct hx9031as_addr_val_pair hx9031as_reg_init_list_as[] = {
    ...
    {RW_A8_PROX_THRES_SHIFT_CFG0,      0x02},
    {RW_A9_PROX_THRES_SHIFT_CFG1,      0x02},
