...
void x_write_cp_disable_2130(void){
	int ret;
	pr_err("x_cp_disable_2130\n");
	ret = sp2130_write_byte(g_sc,SP2130_REG_0E,0x07);
	if(ret == 0){
		pr_err("x_cp_disable_2130 success\n");
	}else{
		pr_err("x_cp_disable_2130 failed\n");
	}
}
EXPORT_SYMBOL(x_write_cp_disable_2130);
